...
@section('content')
<h2 class="text-bold">{{ __("TASK SERVER") }}</h2>
...
<ul class="nav nav-tabs" role="tablist" style="margin-bottom: 15px;">
    ...
    <li class="nav-item">
        <a class="nav-link" onclick="baglanti()" href="#gorevYonetimi" data-toggle="tab">
            <i class="fas fa-tasks"></i> {{ __("Task yönetimi") }}
        </a>
    </li>
</ul>
...
<div class="tab-content">
    ...
    <div id="gorevYonetimi" class="tab-pane">
        @include('gorevYonetimi.baglanti')
    </div>
</div>
@endsection